...
import com.dmd.zsb.mvp.interactor.ChangePasswordInteractor;
...
public class ChangePasswordInteractorImpl implements ChangePasswordInteractor {
    ...
    public void onChangePassword(JsonObject jsonObject) {
        GsonRequest<JsonObject> gsonRequest=new GsonRequest<JsonObject>(UriHelper.getInstance().changePassword(jsonObject),null,new TypeToken<JsonObject>(){}.getType(), new Response.Listener<JsonObject>(){
            @Override
