...
import com.dmd.zsb.mvp.interactor.ReleaseOrderInteractor;
 ...
 */
public class ReleaseOrderInteractorImpl implements ReleaseOrderInteractor {
    ...
    public void onReleaseOrder(JsonObject jsonObject) {
        GsonRequest<JsonObject> gsonRequest=new GsonRequest<JsonObject>(UriHelper.getInstance().saveOrder(jsonObject),null,new TypeToken<JsonObject>(){}.getType(), new Response.Listener<JsonObject>(){
            @Override
